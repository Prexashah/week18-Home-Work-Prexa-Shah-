...
public class ProductsAssertionTest extends TestBase {
    ...
    public void checkTheNameInList() {
    ...
    @Test
    public void checkProductCategoryNameHouseHold() {
    ...
    @Test
    public void verifyCategoryNameHousewares(){
